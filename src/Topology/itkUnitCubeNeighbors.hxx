 ...
 * 
 *=========================================================================*/
#ifndef itkUnitCubeNeighbors_hxx
#define itkUnitCubeNeighbors_hxx
...
namespace itk {
    ...
    neighborhoodSize, std::vector<bool>(neighborhoodSize, false))) {
        assert((unsigned int)Connectivity::Dimension == (unsigned int)NeighborhoodConnectivity::Dimension);
...
//        std::cout << "Output neighbourlist "  << std::endl;
//        for (int neighbor1 = 0; neighbor1 < neighborhoodSize; ++neighbor1) {
//            for (int neighbor2 = 0; neighbor2 < neighborhoodSize; ++neighbor2) {
//                std::cout << neighbor1 << " " << neighbor2 << " " << neighborsInUnitCube[neighbor1][neighbor2] << std::endl;
//            }
//        }
    }
...
#endif // itkUnitCubeNeighbors_hxx
