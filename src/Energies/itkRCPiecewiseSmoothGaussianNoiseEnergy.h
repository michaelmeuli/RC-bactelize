 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCPIECEWISESMOOTHGAUSSIANNOISEENERGY_H
#define	ITKRCPIECEWISESMOOTHGAUSSIANNOISEENERGY_H
...
class ITK_EXPORT RCPiecewiseSmoothGaussianNoiseEnergy :
  ...
  public :
     ...
     */
    //@{
    typedef RCPiecewiseSmoothGaussianNoiseEnergy<TLabelImage, TDataImage, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCPiecewiseSmoothGaussianNoiseEnergy, RCExternalEnergyBaseClass);
    ...
    private:
        RCPiecewiseSmoothGaussianNoiseEnergy(const Self &);  //purposely not implemented
...
#include "itkRCPiecewiseSmoothGaussianNoiseEnergy.hxx"
#endif
