 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCSPRINGPOTENTIALENERGY_H
#define	ITKRCSPRINGPOTENTIALENERGY_H
...
class ITK_EXPORT RCSpringPotentialEnergy :
public RCParticleInteractionEnergyBaseClass<TLabelImage, TOptimizer, TEnergyDifference>
  ...
  public :
     ...
     */
    typedef RCSpringPotentialEnergy<TLabelImage, TOptimizer, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCSpringPotentialEnergy, RCParticleInteractionEnergyBaseClass);
    ...
    private:
        RCSpringPotentialEnergy(const Self &);  //purposely not implemented
...
#include "itkRCSpringPotentialEnergy.hxx"
#endif
 
#endif	/* ITKRCSPRINGPOTENTIALENERGY_H */
