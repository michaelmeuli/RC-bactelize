 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCPIECEWISECONSTANTGAUSSIANNOISEENERGY_H
#define	ITKRCPIECEWISECONSTANTGAUSSIANNOISEENERGY_H
...
class ITK_EXPORT RCPiecewiseConstantGaussianNoiseEnergy :
  ...
  public :
     ...
     */
    //@{
    typedef RCPiecewiseConstantGaussianNoiseEnergy<TLabelImage, TDataImage, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCPiecewiseConstantGaussianNoiseEnergy, RCExternalEnergyBaseClass);
    ...
    private:
        RCPiecewiseConstantGaussianNoiseEnergy(const Self &);  //purposely not implemented
...
#include "itkRCPiecewiseConstantGaussianNoiseEnergy.hxx"
#endif
 
#endif	/* ITKRCPIECEWISECONSTANTGAUSSIANNOISEENERGY_H */
