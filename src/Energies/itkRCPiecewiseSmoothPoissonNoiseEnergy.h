 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCPIECEWISESMOOTHPOISSONNOISEENERGY_H
#define ITKRCPIECEWISESMOOTHPOISSONNOISEENERGY_H
...
class ITK_EXPORT RCPiecewiseSmoothPoissonNoiseEnergy :
  ...
  public :
     ...
     */
    //@{
    typedef RCPiecewiseSmoothPoissonNoiseEnergy<TLabelImage, TDataImage, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCPiecewiseSmoothPoissonNoiseEnergy, RCExternalEnergyBaseClass);
    ...
    private:
        RCPiecewiseSmoothPoissonNoiseEnergy(const Self &);  //purposely not implemented
...
#include "itkRCPiecewiseSmoothPoissonNoiseEnergy.hxx"
#endif
 
#endif	/* ITKRCPIECEWISESMOOTHPOISSONNOISEENERGY_H */
