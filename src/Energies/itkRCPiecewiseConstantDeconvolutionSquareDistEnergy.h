 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCPIECEWISECONSTANTDECONVOLUTIONSQUAREDISTENERGY_H
#define	ITKRCPIECEWISECONSTANTDECONVOLUTIONSQUAREDISTENERGY_H
...
class ITK_EXPORT RCPiecewiseConstantDeconvolutionSquareDistEnergy :
  ...
  public :
     ...
     */
    //@{
    typedef RCPiecewiseConstantDeconvolutionSquareDistEnergy<TLabelImage, TDataImage, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCPiecewiseConstantDeconvolutionSquareDistEnergy, 
    ...
    private:
        RCPiecewiseConstantDeconvolutionSquareDistEnergy(const Self &);  //purposely not implemented
...
#include "itkRCPiecewiseConstantDeconvolutionSquareDistEnergy.hxx"
#endif
 
#endif	/* ITKRCPIECEWISECONSTANTDECONVOLUTIONSQUAREDISTENERGY_H */
