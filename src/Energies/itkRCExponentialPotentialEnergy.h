 ...
 * Janick Cardinale
 *=========================================================================*/
#ifndef ITKRCEXPONENTIALPOTENTIALENERGY_H
#define	ITKRCEXPONENTIALPOTENTIALENERGY_H
 ...
 * 
 * 
 * TODO: handles only isotropic images so far.
 */
template<class TLabelImage, class TOptimizer, class TEnergyDifference = float>
class ITK_EXPORT RCExponentialPotentialEnergy :
public RCParticleInteractionEnergyBaseClass<TLabelImage, TOptimizer, TEnergyDifference>
  {
  public :
    /**
     * @name Standard ITK declarations
     */
    typedef RCExponentialPotentialEnergy<TLabelImage, TOptimizer, TEnergyDifference> Self;
    ...
    itkNewMacro(Self);
    itkTypeMacro(RCExponentialPotentialEnergy, RCParticleInteractionEnergyBaseClass);
    ...
    private:
        RCExponentialPotentialEnergy(const Self &);  //purposely not implemented
...
#include "itkRCExponentialPotentialEnergy.hxx"
#endif
 
#endif	/* ITKRCEXPONENTIALPOTENTIALENERGY_H */
